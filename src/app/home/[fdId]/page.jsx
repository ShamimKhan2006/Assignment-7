...
const FriendsDetails = async ({ params }) => {
  ...
  <div className="flex flex-wraplg:justify-between items-center gap-6">
              <div className="mx-auto container ">
               ...
               <div className="bg-base-200 w-full p-20 rounded-md mt-4">
              <h1 className="font-medium mb-4">Quick Check-In</h1>
              <div className="grid flex-cols md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className=" bg-white p-6 text-center mb-6 font-semibold">
